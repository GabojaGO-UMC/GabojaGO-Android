...
class DialogRealFolderrecordDelete(private val folderIdx:Int) : DialogFragment() ,FolderrecordingDeleteView{
    ...
    override fun onCreateView(
        ...
        recordService.setFolderrecordingDeleteView(this@DialogRealFolderrecordDelete)

        binding.dialogYesBtn.setOnClickListener {
            val userJwt = getJwt(requireContext(), "userJwt")
            recordService.putFolderDelete(userJwt, folderIdx)
        }
    ...
    override fun onFolderrecordingDeleteSuccess() {
